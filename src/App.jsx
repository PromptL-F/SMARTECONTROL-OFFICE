...
const ESP_IP = "http://192.168.5.127";

const BT_SERVICE_UUID = '6e400001-b5a3-f393-e0a9-e50e24dcca9e';
const BT_CHAR_TX_UUID = '6e400002-b5a3-f393-e0a9-e50e24dcca9e'; 
const BT_CHAR_RX_UUID = '6e400003-b5a3-f393-e0a9-e50e24dcca9e'; 
...
function WifiApp({ currentUser, onLogout, onSwitchMode }) {
  ...
  const resetAll = async () => {
    ...
    await api('/reset', {reset:true}); setResetting(false);
  };
